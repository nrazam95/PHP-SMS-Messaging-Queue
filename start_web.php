...
$web = new Worker("http://$_ENV[FRONTEND_HOST]:$_ENV[FRONTEND_PORT]");
$web->name = 'web';

define('WEBROOT', __DIR__ . DIRECTORY_SEPARATOR .  'views');
...
$web->onMessage = function (TcpConnection $connection, Request $request) {
    ...
    if (false === $file) {
        $connection->send(new Response(404, array(), "<h3>404 Not Found</h3>" . $file));
        return;
    }
